...
- once you are finished navigate to the `Manage exsisting genesis` and the export your genesis configuration. For this you care about yournetworkname.json that will be created.
  * example configuration<br/> <img src= 'https://user-images.githubusercontent.com/26451572/130343060-cff3ab7d-63d6-4116-876a-c9ffb8eccbe4.png' width="700" height="600" />   
5. Now we need to initalize the nodes with the genesis file
In the Geth library run:<br/>
* `./geth --datadir node1 init networkname.json`<br/>
* `./geth --datadir node2 init networkname.json`<br/>
6. Next we can have the nodes begin mining. Using seperate terminals navigate to the the geth library and then run:<br/>
